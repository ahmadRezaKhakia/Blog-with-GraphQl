...
import {Card , CardHeader , CardMedia , CardContent,CardActions , Avatar , Typography,Divider,Button} from '@mui/material'
...
function CardEL({title,slug,coverPhoto,author}) {
    return (
        <Card sx={{ boxShadow: "rgba(0,0,0,0.1) 0px 4px 12px", borderRadius: 4 }}>
            ...
            <CardContent>
                <Typography component="h3" variant='overline' color="text.primary" fontWeight={800}>
                    {title}
                </Typography>
            </CardContent>
